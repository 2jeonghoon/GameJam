...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField]
    private KeyCode keyCodeJump = KeyCode.Space; // 달리기 키
    ...
    private void UpdateMove()
    {
        ...
        if( x != 0 || z != 0)
        {
            ...
            // 방향키 입력 여부 여부는 매 프레임 확인하기 때문에
            // 재생중일 때는 다시 재생하기 않도록 isPlaying으로 체크해서 재생
